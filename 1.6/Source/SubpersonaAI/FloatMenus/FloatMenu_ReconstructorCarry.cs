...
{
    public class FloatMenu_ReconstructorCarry : HumanlikeOrdersUtil.FloatMenuPatch
	{
        public override IEnumerable<KeyValuePair<Condition, Func<Vector3, Pawn, Thing, List<FloatMenuOption>>>> GetFloatMenus()
		{
			...
			var curCondition = new Condition(ConditionType.ThingHasComp, typeof(Comp_ProgramCartridgeSlot));
